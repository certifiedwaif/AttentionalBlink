...
for thisSample = 1:nSamples
    ...
    for thisParticipant = 1:nParticipants
        ...
        elseif isempty(zeroPoint)

            startLag = round(thisCompResult - 0.5);
            endLag = round(thisCompResult + 0.5);
            thisSlope = fit((startLag:endLag)', modelDiff(startLag:endLag)', 'poly1'); % Fit a linear function
    ...
    T1Performance = NaN(nParticipants,nLags);
    T2Performance = NaN(nParticipants,nLags);
    T2GivenT1Performance = NaN(nParticipants,nLags);
    ...
    T1PerformanceSD = std(T1Performance);
    ...
    T2GivenT1PerformanceSD = std(T2GivenT1Performance);
